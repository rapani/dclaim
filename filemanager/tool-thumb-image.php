...
if(empty($imageinfo)){return 0;}
$image->width=$imageinfo[0];$image->height=$imageinfo[1];$image->type=$imageinfo[2];
...
//@imagefilledrectangle($image, 0, 0, 96, 96, $color);
//@imagecopyresized($image,$im1,0,0,0,0,96,96,96,96);
//$image = $im1;
