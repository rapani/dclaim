...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <div class="image-editor-filename-name-area"><input type="text" name="curfilepath" id="curfilepath" value="<?php echo htmlspecialchars(stripslashes($_GET['filepath']));?>" /><input type="hidden" name="curfileurl" id="curfileurl" value="<?php echo htmlspecialchars(stripslashes($url));?>" />
  ...
  <div class="image-editor-middle">
    ...
    <div class="image-editor-sidebar-inner">
      <div class="original-image"><img id="imageori" src="<?php echo htmlspecialchars(stripslashes($url));?>?rand=<?php echo mt_rand(1111,9999);?>" /></div>
      ...
      <div class="image-editor-tool">
      	<div class="image-editor-tool-item image-tool-resize"><a href="javascript:resizeImage('<?php echo htmlspecialchars(stripslashes($_GET['filepath']));?>')">Resize Image</a></div>
        <div class="image-tool-resize-dimension">
            ...
            <table width="150" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td colspan="2"><label><input type="checkbox" name="aspecratio" id="aspecratio" value="1" checked="checked" /> Keep aspec ratio</label></td>
                </tr>
              <tr>
                <td colspan="2"><label><input type="checkbox" name="cropimage" id="cropimage" value="1" /> Crop image on center</label></td>
                </tr>
            </table>
          </div>
        
        </div>
      	<div class="image-editor-tool-item image-tool-rotate-cw"><a href="javascript:rotateCW('<?php echo htmlspecialchars(stripslashes($_GET['filepath']));?>')">Rotate Clockwise</a></div>
      	<div class="image-editor-tool-item image-tool-rotate-ccw"><a href="javascript:rotateCCW('<?php echo htmlspecialchars(stripslashes($_GET['filepath']));?>')">Rotate Counterclockwise</a></div>
      	<div class="image-editor-tool-item image-tool-flip-h"><a href="javascript:flipH('<?php echo htmlspecialchars(stripslashes($_GET['filepath']));?>')">Flip Horizontal</a></div>
      	<div class="image-editor-tool-item image-tool-flip-v"><a href="javascript:flipV('<?php echo htmlspecialchars(stripslashes($_GET['filepath']));?>')">Flip Vertical</a></div>
      </div>
	...
	<div class="image-editor-mainbar">
    	<div class="image-editor-mainbar-inner">
        	<div id="image-content">
            	<img id="image2edit" src="<?php echo htmlspecialchars(stripslashes($url));?>?rand=<?php echo mt_rand(1111,9999);?>" />
            </div>
        </div>
    </div>  
  </div>
