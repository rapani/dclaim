...
$id = $_GET['id'];
$sql = "SELECT * FROM ritl WHERE id='$id'";
...
<div class="card">
  <h5 class="card-header">UPLOAD DOCUMENT DIGITAL CLAIM RAWAT INAP : <?php echo $row['no_sep']; ?></h5>
  <div class="card-body">


<form action="konten/prosesri.php" method="post" enctype="multipart/form-data">
...
<div class="form-row">
  ...
  <div class="form-group col-md-3">
    ...
    <input type="text" class="form-control" id="poli" value="RAWAT INAP" disabled>
  </div>


<div class="form-group col-md-6">
  <label for="tgl"><b>TGL PULANG </b>: </label>
  <input type="text" id="tgl" class="form-control" name="tgl_pulang" required>
</div>
